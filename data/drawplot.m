numVars = 3;
varNames = {'field.data0.pose.position.x', 'field.data0.pose.position.y', 'field.data0.pose.position.z'};
...
plot_data = readtable('C:\Users\Junyoung\Desktop\matlab\TWR\slow/bag.xls', opts);
